        ...
        Subtask(
            ...
            conditions={
                "rubiks_cube": [
                    ...
                    partial(object_behind, object="rubiks_cube", reference_object="bowl", frame_of_reference="robot", mirrored=False, require_contact_with="table", require_gripper_detached=True),
                ],
            },
            logical="all",
            score=1.0
