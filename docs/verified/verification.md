...
| bimanual YAM | rig + MolmoAct 2 client | MolmoAct 2 (Ai2, released) | 1 | parity task 5/8 in RoboLab vs 4/8 in Ai2's ManiSkill harness, same checkpoint; BananaInBowl, BBQSauceInBin, FoodPacking2Cans 0/4 each (policy hovers, picks the wrong object, or releases) |
